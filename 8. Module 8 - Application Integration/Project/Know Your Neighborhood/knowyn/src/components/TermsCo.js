          ...
          <div className="row content mb-5">
            <div className="col-lg-12">
              <p>
                ...
                the use of Pratama Corp's Website, located at
                http://localhost:3000/.
              </p>

              <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use Know Your Neighborhood if you
              ...
              <p>
                ...
                and subject to, prevailing law of id. Any use of the above
              ...
              <p>
                We employ the use of cookies. By accessing Know Your
                Neighborhood, you agreed to use cookies in agreement with the
                Pratama Corp's Privacy Policy.{" "}
              </p>
              ...
              <p>
                Unless otherwise stated, Pratama Corp and/or its licensors own
                the intellectual property rights for all material on Know Your
                Neighborhood. All intellectual property rights are reserved. You
                may access this from Know Your Neighborhood for your own
              ...
              <p>You must not:</p>
              <ul>
                <li>Republish material from Know Your Neighborhood</li>
                <li>
                  Sell, rent or sub-license material from Know Your Neighborhood
                </li>
                <li>
                  Reproduce, duplicate or copy material from Know Your
                  Neighborhood
                </li>
                <li>Redistribute content from Know Your Neighborhood</li>
              </ul>
              ...
              <p>
                ...
                website. Pratama Corp does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of Pratama Corp,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, Pratama Corp shall not be liable
              ...
              <p>
                Pratama Corp reserves the right to monitor all Comments and to
              ...
              <p>
                You hereby grant Pratama Corp a non-exclusive license to use,
              ...
              <p>
                ...
                of Pratama Corp; and (d) the link is in the context of general
              ...
              <p>
                ...
                by sending an e-mail to Pratama Corp. Please include your name,
              ...
              <p>
                No use of Pratama Corp's logo or other artwork will be allowed
