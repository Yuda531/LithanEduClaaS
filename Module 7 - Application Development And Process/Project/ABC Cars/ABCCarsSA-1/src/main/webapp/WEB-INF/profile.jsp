...
<head>
<meta charset="utf-8">
<title>ABC Cars Pte Ltd | Profile</title>
							...
							<sf:form action="update" method="post" class="was-validated"
								...
								<div class="mb-3">
                                    ...
                                    <button type="submit" class="btn text-white"
                                            style="background-color: #0d6efd;">Update</button>
                                </div>
                            	</sf:form>
                            </div>
										...
										<tbody>
											<c:forEach items="${cars}" var="c" varStatus="status">
												<tr>
													...
													<td>${c.postDate}</td>
													<td>
														<!-- view car --> <a type="button" class="btn"
														href="/car_detail?cid=${c.id}"
														style="background-color: #0d6efd;"> <i
															class="far fa-eye text-white"></i>
