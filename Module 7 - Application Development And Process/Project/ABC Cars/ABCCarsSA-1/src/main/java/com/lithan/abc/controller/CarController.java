package com.lithan.abc.controller;
...
import com.lithan.abc.service.CarService;
import com.lithan.abc.service.UserService;
...
public class CarController {
	...
	public String saveCar(@ModelAttribute("car") Car car, RedirectAttributes ra,
		...
		String uploadDir = "./src/main/webapp/images/car-photo/" + savedCar.getId();
