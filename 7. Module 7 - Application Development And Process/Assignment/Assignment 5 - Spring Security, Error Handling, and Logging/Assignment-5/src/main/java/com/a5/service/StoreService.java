...
import com.a5.exception.StoreNotFoundException;
import com.a5.repository.StoreRepository;
...
public class StoreService {
	...
	public List<Store> searchStore(String email) {
		...
		if(userResponse.isEmpty()) {
			throw new StoreNotFoundException("No store exists for " + email + " entered");
		}
