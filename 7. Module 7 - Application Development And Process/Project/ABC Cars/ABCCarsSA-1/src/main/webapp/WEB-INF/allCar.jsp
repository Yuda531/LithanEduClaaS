...
<head>
<meta charset="utf-8">
<title>ABC Cars Pte Ltd | All Cars</title>
					...
					<tbody>
						<c:forEach items="${cars}" var="c" varStatus="status">
							<tr>
								...
								<td>${c.model}</td>
								<td>${c.price}</td>
								<td><a type="button" class="btn text-white" style="background-color: #0d6efd;"
										...
										<div class="modal-dialog">
											<div class="modal-content">
													...
													<sf:form action="/edit_car?cid=${c.id}" method="post"
														...
														<div class="mb-3">
															<label for="price" class="d-flex form-label">Price
																(Rp.):</label> <input type="text" class="form-control" id="price"
												...
												<div class="modal-footer">
													...
													<button type="submit" class="btn text-white d-flex" style="background-color: #0d6efd;">Edit</button>
												</div>
												</sf:form>
												</div>
											</div>
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													...
													<sf:form action="/sale_status?cid=${c.id}" method="post"
														...
														<button type="submit" class="btn text-white" style="background-color: #0d6efd;">Set</button>
													</sf:form>
												</div>
											</div>
										</div>
